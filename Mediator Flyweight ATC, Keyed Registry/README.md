...
Part two: Registry design pattern. Existing Observer code using an Event Registry was modified to use strings as the key for each subject instead of pointers.
